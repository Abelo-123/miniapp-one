                            ...
                            Swal.default.fire({
                                ...
                                html: `
                                    <div style="text-align: left; font-size: 13px; line-height: 1.6; max-height: 400px; overflow-y: auto; padding-right: 8px;">
                                        ...
                                        <p style="margin-bottom: 12px;"><strong>2. Description of Services</strong><br>Paxyo provides digital marketing and social media engagement services, including likes, views, followers, and other engagement metrics. Paxyo operates as a licensed marketing service provider in Ethiopia and is not affiliated with any social media platforms.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>3. User Responsibilities</strong><br>Users agree to: provide accurate and valid order details (links, usernames, etc.), ensure accounts or content are public and accessible, and not use Paxyo for illegal, harmful, or misleading purposes. Paxyo is not responsible for issues caused by incorrect information provided by the user.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>4. Orders & Processing</strong><br>Orders begin after payment is successfully completed. Orders cannot be canceled or modified once processing has started. Delivery time may vary depending on the service and demand. Some services may start instantly, while others may take time.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>5. Service Performance Disclaimer</strong><br>Paxyo does not guarantee permanent results for all services. Social media platforms may update their systems, which can affect delivery. Drops in followers, likes, or views may occur over time.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>6. Refund & Balance Policy</strong><br>Paxyo does not provide refunds to bank accounts, mobile money, or external payment methods. If an order is partially completed, canceled, or fails, the remaining amount will be returned to the user's Paxyo balance. Users can reuse this balance to place new orders at any time. Paxyo balance cannot be withdrawn as cash.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>7. Data Privacy & Security</strong><br>Paxyo respects user privacy and does not sell, rent, or share user data with third parties. User information is stored using secure systems and modern encryption practices to protect against unauthorized access. Sensitive data is handled with strict internal controls and is only accessible when necessary for system operation or support. Paxyo team members do not access personal user data unless required to resolve a support issue. We continuously improve our security measures to keep user data safe.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>8. Pricing & Payments</strong><br>All prices are displayed inside the platform and may change at any time. Users are responsible for reviewing service details before placing orders. Paxyo is not responsible for issues caused by third-party payment providers.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>9. Account & Security</strong><br>Users are responsible for maintaining the security of their accounts. Paxyo is not liable for unauthorized access due to user negligence.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>10. Prohibited Activities</strong><br>Users must not: use Paxyo for fraudulent or deceptive purposes, attempt to exploit or harm the system, or use automation or bots to abuse services. Violations may result in account suspension.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>11. Account Suspension & Termination</strong><br>Paxyo reserves the right to suspend or terminate accounts that violate these terms or engage in suspicious activity. No refunds will be provided in such cases.</p>
                                        
                                        <p style="margin-bottom: 12px;"><strong>12. Limitation of Liability</strong><br>Paxyo is not responsible for: any loss of profits, data, or business opportunities, social media account restrictions or bans, or any indirect damages resulting from service use. All services are used at the user's own risk.</p>
