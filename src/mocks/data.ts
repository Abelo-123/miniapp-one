...
export const MOCK_SERVICES: Service[] = [
    ...
    { id: 1005, category: 'Instagram Comments', name: 'Instagram Custom Comments', type: 'Custom Comments', rate: 8.00, original_rate: 8.00, min: 5, max: 500, averageTime: '1-6 Hours', refill: false, cancel: false },
    { id: 2001, category: 'TikTok Followers', name: 'TikTok Followers [Real] [Max: 50K]', type: 'Default', rate: 3.00, original_rate: 3.00, min: 100, max: 50000, averageTime: '0-6 Hours', refill: true, cancel: false },
    { id: 2002, category: 'TikTok Views', name: 'TikTok Video Views [Max: 10M]', type: 'Default', rate: 0.10, original_rate: 0.10, min: 500, max: 10000000, averageTime: '0-1 Hours', refill: false, cancel: false },
    { id: 2003, category: 'TikTok Likes', name: 'TikTok Likes [Max: 100K]', type: 'Default', rate: 1.20, original_rate: 1.20, min: 50, max: 100000, averageTime: '0-2 Hours', refill: false, cancel: false },
    { id: 3001, category: 'YouTube Subscribers', name: 'YouTube Subscribers [Real] [Max: 10K]', type: 'Default', rate: 15.00, original_rate: 15.00, min: 50, max: 10000, averageTime: '2-12 Hours', refill: true, cancel: false },
    { id: 3002, category: 'YouTube Views', name: 'YouTube Views [Max: 1M]', type: 'Default', rate: 1.00, original_rate: 1.00, min: 500, max: 1000000, averageTime: '0-4 Hours', refill: false, cancel: false },
    { id: 3003, category: 'YouTube Likes', name: 'YouTube Likes [Max: 50K]', type: 'Default', rate: 3.50, original_rate: 3.50, min: 50, max: 50000, averageTime: '0-6 Hours', refill: false, cancel: false },
    { id: 4001, category: 'Facebook Page Likes', name: 'Facebook Page Likes [Max: 50K]', type: 'Default', rate: 4.00, original_rate: 4.00, min: 100, max: 50000, averageTime: '0-12 Hours', refill: true, cancel: false },
    { id: 4002, category: 'Facebook Post Likes', name: 'Facebook Post Likes [Max: 10K]', type: 'Default', rate: 2.00, original_rate: 2.00, min: 50, max: 10000, averageTime: '0-4 Hours', refill: false, cancel: false },
    { id: 5001, category: 'Twitter / X Followers', name: 'Twitter Followers [Real] [Max: 50K]', type: 'Default', rate: 6.00, original_rate: 6.00, min: 100, max: 50000, averageTime: '0-12 Hours', refill: true, cancel: false },
    { id: 5002, category: 'Twitter / X Likes', name: 'Twitter Likes [Max: 10K]', type: 'Default', rate: 2.50, original_rate: 2.50, min: 50, max: 10000, averageTime: '0-4 Hours', refill: false, cancel: false },
    { id: 6001, category: 'Telegram Members', name: 'Telegram Channel Members [Max: 50K]', type: 'Default', rate: 5.50, original_rate: 5.50, min: 100, max: 50000, averageTime: '0-24 Hours', refill: true, cancel: false },
    { id: 6002, category: 'Telegram Post Views', name: 'Telegram Post Views [Max: 100K]', type: 'Default', rate: 0.50, original_rate: 0.50, min: 100, max: 100000, averageTime: '0-1 Hours', refill: false, cancel: false },
